...
import MedicFilterOdonto from './MedicFilterOdonto';
import OdontologyList from './OdontologyList';
import './Medic.css';
 
const Medicodonto = (props) => {
  ...
  return (
    <div>
      <Card className='medic'>
        ...
        />
        <OdontologyList items={filteredPerson} />
      </Card>
    </div>
  );
};

export default Medicodonto;